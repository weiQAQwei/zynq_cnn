...
#define XPAR_CNN_TOP_0_COMPATIBLE "xlnx,cnn-top-1.0"
#define XPAR_CNN_TOP_0_BASEADDR 0x40000000
#define XPAR_CNN_TOP_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral CNN_TOP_0 */
#define XPAR_XCNN_TOP_0_BASEADDR 0x40000000
#define XPAR_XCNN_TOP_0_HIGHADDR 0x4000ffff
#define XPAR_XCNN_TOP_0_COMPATIBLE "xlnx,cnn-top-1.0"
