...
entity cnn_top_load_params_func_Pipeline_VITIS_LOOP_40_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_top_load_params_func_Pipeline_VITIS_LOOP_40_5 is 
...
attribute shreg_extract : string;
    ...
    signal gmem7_addr_read_reg_139 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    add_ln40_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_oc_1) + unsigned(ap_const_lv6_1));
    ...
    ap_block_state2_pp0_stage1_iter0_assign_proc : process(m_axi_gmem7_0_RVALID)
    begin
                ap_block_state2_pp0_stage1_iter0 <= (m_axi_gmem7_0_RVALID = ap_const_logic_0);
    end process;
    ...
    ap_sig_allocacmp_oc_1_assign_proc : process(ap_CS_fsm_state1, oc_fu_48, ap_loop_init)
    begin
    ...
    gmem7_blk_n_R_assign_proc : process(m_axi_gmem7_0_RVALID, ap_CS_fsm_state2)
    begin
    ...
    icmp_ln40_fu_88_p2 <= "1" when (ap_sig_allocacmp_oc_1 = ap_const_lv6_20) else "0";
    ...
    local_bias_d0 <= gmem7_addr_read_reg_139;
    ...
    m_axi_gmem7_0_RREADY_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_pp0_stage1_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_pp0_stage1_iter0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    trunc_ln42_fu_106_p1 <= ap_sig_allocacmp_oc_1(5 - 1 downto 0);
