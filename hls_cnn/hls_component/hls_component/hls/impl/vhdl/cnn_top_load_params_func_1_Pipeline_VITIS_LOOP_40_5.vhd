...
entity cnn_top_load_params_func_1_Pipeline_VITIS_LOOP_40_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_top_load_params_func_1_Pipeline_VITIS_LOOP_40_5 is 
...
attribute shreg_extract : string;
    ...
    signal gmem5_addr_read_reg_139 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2_pp0_stage1_iter0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                gmem5_addr_read_reg_139 <= m_axi_gmem5_0_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln40_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_oc_2) + unsigned(ap_const_lv6_1));
    ...
    ap_block_state2_pp0_stage1_iter0_assign_proc : process(m_axi_gmem5_0_RVALID)
    begin
                ap_block_state2_pp0_stage1_iter0 <= (m_axi_gmem5_0_RVALID = ap_const_logic_0);
    end process;
    ...
    ap_sig_allocacmp_oc_2_assign_proc : process(ap_CS_fsm_state1, oc_fu_48, ap_loop_init)
    begin
    ...
    gmem5_blk_n_R_assign_proc : process(m_axi_gmem5_0_RVALID, ap_CS_fsm_state2)
    begin
    ...
    icmp_ln40_fu_88_p2 <= "1" when (ap_sig_allocacmp_oc_2 = ap_const_lv6_20) else "0";
    ...
    local_bias_d0 <= gmem5_addr_read_reg_139;
    ...
    m_axi_gmem5_0_ARADDR <= ap_const_lv32_0;
    ...
    m_axi_gmem5_0_RREADY_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_pp0_stage1_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_pp0_stage1_iter0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    trunc_ln42_fu_106_p1 <= ap_sig_allocacmp_oc_2(5 - 1 downto 0);
