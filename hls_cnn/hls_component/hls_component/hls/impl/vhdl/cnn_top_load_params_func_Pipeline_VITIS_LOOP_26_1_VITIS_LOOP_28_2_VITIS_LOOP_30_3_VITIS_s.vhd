...
entity cnn_top_load_params_func_Pipeline_VITIS_LOOP_26_1_VITIS_LOOP_28_2_VITIS_LOOP_30_3_VITIS_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_top_load_params_func_Pipeline_VITIS_LOOP_26_1_VITIS_LOOP_28_2_VITIS_LOOP_30_3_VITIS_s is 
...
attribute shreg_extract : string;
    ...
    signal gmem6_addr_read_reg_579 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln34_4_fu_477_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal select_ln30_1_fu_232_p3 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal select_ln26_1_fu_300_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal indvar_flatten35_fu_102 : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal add_ln26_1_fu_178_p2 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal add_ln30_1_fu_226_p2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal empty_51_fu_354_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_52_fu_359_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln30_fu_348_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln34_fu_380_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal trunc_ln34_1_fu_384_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_s_fu_388_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal p_shl1_fu_400_p4 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln34_fu_396_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal sub_ln34_fu_410_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln34_1_fu_416_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl_fu_455_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal zext_ln34_2_fu_452_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal sub_ln34_1_fu_462_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal zext_ln34_3_fu_468_p1 : STD_LOGIC_VECTOR (13 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln26_fu_172_p2 = ap_const_lv1_0)) then 
                    indvar_flatten35_fu_102 <= add_ln26_1_fu_178_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln26_fu_172_p2 = ap_const_lv1_0)) then 
                    indvar_flatten_fu_86 <= select_ln30_1_fu_232_p3;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_loop_init = ap_const_logic_1))) then 
                ...
                oc_fu_98 <= select_ln26_1_fu_300_p3;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2_pp0_stage1_iter0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                ...
                gmem6_addr_read_reg_579 <= m_axi_gmem6_0_RDATA;
    ...
    add_ln26_1_fu_178_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten35_load) + unsigned(ap_const_lv14_1));
    ...
    add_ln30_1_fu_226_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv4_1));
    ...
    add_ln34_1_fu_471_p2 <= std_logic_vector(unsigned(sub_ln34_1_fu_462_p2) + unsigned(zext_ln34_3_fu_468_p1));
    add_ln34_fu_420_p2 <= std_logic_vector(unsigned(sub_ln34_fu_410_p2) + unsigned(zext_ln34_1_fu_416_p1));
    ...
    ap_block_state2_pp0_stage1_iter0_assign_proc : process(m_axi_gmem6_0_RVALID)
    begin
                ap_block_state2_pp0_stage1_iter0 <= (m_axi_gmem6_0_RVALID = ap_const_logic_0);
    end process;
    ...
    empty_51_fu_354_p2 <= (icmp_ln31_mid211_fu_335_p2 or and_ln26_1_reg_557);
    empty_52_fu_359_p2 <= (icmp_ln28_reg_539 or empty_51_fu_354_p2);
    ...
    gmem6_blk_n_R_assign_proc : process(m_axi_gmem6_0_RVALID, ap_CS_fsm_state2)
    begin
    ...
    local_weights_address0 <= zext_ln34_4_fu_477_p1(14 - 1 downto 0);
    ...
    local_weights_d0 <= gmem6_addr_read_reg_579;
    ...
    m_axi_gmem6_0_ARADDR <= ap_const_lv32_0;
    ...
    m_axi_gmem6_0_RREADY_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_pp0_stage1_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_pp0_stage1_iter0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_mid26_fu_313_p3 <= 
        ...
        m_fu_82;
    n_mid2_fu_364_p3 <= 
        ap_const_lv2_0 when (empty_52_fu_359_p2(0) = '1') else 
        n_fu_78;
    not_exitcond_flatten_mid234_fu_325_p2 <= (icmp_ln28_reg_539 or exitcond_flatten_not_fu_320_p2);
    p_shl1_fu_400_p4 <= ((trunc_ln34_fu_380_p1 & trunc_ln34_1_fu_384_p1) & ap_const_lv2_0);
    p_shl_fu_455_p3 <= (add_ln34_reg_573 & ap_const_lv2_0);
    select_ln26_1_fu_300_p3 <= 
    ...
    select_ln28_fu_341_p3 <= 
        ...
        select_ln26_fu_287_p3;
    select_ln30_1_fu_232_p3 <= 
        ap_const_lv4_1 when (empty_fu_220_p2(0) = '1') else 
        add_ln30_1_fu_226_p2;
    select_ln30_fu_372_p3 <= 
        add_ln30_fu_348_p2 when (icmp_ln31_mid211_fu_335_p2(0) = '1') else 
        m_mid26_fu_313_p3;
    sub_ln34_1_fu_462_p2 <= std_logic_vector(unsigned(p_shl_fu_455_p3) - unsigned(zext_ln34_2_fu_452_p1));
    sub_ln34_fu_410_p2 <= std_logic_vector(unsigned(p_shl1_fu_400_p4) - unsigned(zext_ln34_fu_396_p1));
    tmp_s_fu_388_p3 <= (trunc_ln34_fu_380_p1 & trunc_ln34_1_fu_384_p1);
    trunc_ln34_1_fu_384_p1 <= select_ln28_fu_341_p3(5 - 1 downto 0);
    trunc_ln34_fu_380_p1 <= select_ln26_1_fu_300_p3(5 - 1 downto 0);
    xor_ln26_fu_202_p2 <= (icmp_ln28_fu_196_p2 xor ap_const_lv1_1);
    zext_ln34_1_fu_416_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln30_fu_372_p3),12));
    zext_ln34_2_fu_452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln34_reg_573),14));
    zext_ln34_3_fu_468_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n_mid2_reg_568),14));
    zext_ln34_4_fu_477_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln34_1_fu_471_p2),32));
