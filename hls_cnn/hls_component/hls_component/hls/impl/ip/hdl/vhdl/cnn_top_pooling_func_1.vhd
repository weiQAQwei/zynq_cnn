...
entity cnn_top_pooling_func_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_top_pooling_func_1 is 
...
attribute shreg_extract : string;
    ...
    signal empty_47_fu_257_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal empty_47_reg_458 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal empty_48_fu_261_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal empty_48_reg_464 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal max_val_4_fu_411_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal max_val_4_reg_502 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln163_1_fu_358_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal zext_ln163_2_fu_374_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal select_ln157_fu_249_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal indvar_flatten_fu_66 : STD_LOGIC_VECTOR (9 downto 0) := "0000000000";
    signal select_ln157_1_fu_319_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_fu_70 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal select_ln155_1_fu_221_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal indvar_flatten12_fu_74 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal add_ln155_1_fu_160_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal input_buf_address1_local : STD_LOGIC_VECTOR (12 downto 0);
    signal input_buf_ce0_local : STD_LOGIC;
    signal input_buf_address0_local : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal add_ln155_fu_183_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln155_fu_195_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal and_ln155_fu_215_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln157_fu_229_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal c_mid2_fu_241_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_s_fu_269_p6 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_1_fu_288_p6 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln157_1_fu_313_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_2_fu_347_p6 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_3_fu_363_p6 : STD_LOGIC_VECTOR (12 downto 0);
    signal icmp_ln164_fu_379_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage3 : BOOLEAN;
    signal icmp_ln164_1_fu_393_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal max_val_3_fu_398_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln155_fu_154_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    ...
                    indvar_flatten12_fu_74 <= ap_const_lv12_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln155_1_fu_160_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten12_load) + unsigned(ap_const_lv12_1));
    add_ln155_fu_183_p2 <= std_logic_vector(unsigned(i_fu_70) + unsigned(ap_const_lv4_1));
    add_ln157_1_fu_313_p2 <= std_logic_vector(unsigned(indvar_flatten_fu_66) + unsigned(ap_const_lv10_1));
    add_ln157_fu_229_p2 <= std_logic_vector(unsigned(select_ln155_fu_195_p3) + unsigned(ap_const_lv4_1));
    ...
    ap_block_pp0_stage0_01001_grp1_assign_proc : process(ap_enable_reg_pp0_iter1, pool1_out_full_n)
    begin
                ap_block_pp0_stage0_01001_grp1 <= ((pool1_out_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, pool1_out_full_n)
    begin
                ap_block_pp0_stage0_11001 <= ((pool1_out_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_pp0_stage0_11001_grp0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_11001_grp1_assign_proc : process(ap_enable_reg_pp0_iter1, pool1_out_full_n)
    begin
                ap_block_pp0_stage0_11001_grp1 <= ((pool1_out_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_pp0_stage0_grp1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, pool1_out_full_n)
    begin
                ap_block_pp0_stage0_subdone <= ((pool1_out_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    c_mid2_fu_241_p3 <= 
        ...
        c_fu_58;
    empty_47_fu_257_p1 <= select_ln155_1_fu_221_p3(3 - 1 downto 0);
    empty_48_fu_261_p1 <= select_ln157_fu_249_p3(3 - 1 downto 0);
    empty_fu_235_p2 <= (icmp_ln157_fu_189_p2 or and_ln155_fu_215_p2);
    icmp_ln155_fu_154_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten12_load = ap_const_lv12_800) else "0";
    icmp_ln157_fu_189_p2 <= "1" when (indvar_flatten_fu_66 = ap_const_lv10_100) else "0";
    ...
    icmp_ln164_2_fu_405_p2 <= "1" when (signed(input_buf_q0) > signed(max_val_3_fu_398_p3)) else "0";
    icmp_ln164_fu_379_p2 <= "1" when (signed(input_buf_q0) > signed(input_buf_q1)) else "0";
    input_buf_address0 <= input_buf_address0_local;

    input_buf_address0_local_assign_proc : process(ap_enable_reg_pp0_iter0_reg, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage1, zext_ln163_fu_302_p1, ap_block_pp0_stage2, zext_ln163_2_fu_374_p1)
    begin
        if ((ap_enable_reg_pp0_iter0_reg = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                input_buf_address0_local <= zext_ln163_2_fu_374_p1(13 - 1 downto 0);
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                input_buf_address0_local <= zext_ln163_fu_302_p1(13 - 1 downto 0);
            else 
                input_buf_address0_local <= "XXXXXXXXXXXXX";
            end if;
        else 
            input_buf_address0_local <= "XXXXXXXXXXXXX";
        end if; 
    ...
    input_buf_address1_local_assign_proc : process(ap_enable_reg_pp0_iter0_reg, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, zext_ln160_fu_283_p1, ap_block_pp0_stage1, zext_ln163_1_fu_358_p1, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0_reg = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                input_buf_address1_local <= zext_ln163_1_fu_358_p1(13 - 1 downto 0);
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                input_buf_address1_local <= zext_ln160_fu_283_p1(13 - 1 downto 0);
            else 
                input_buf_address1_local <= "XXXXXXXXXXXXX";
            end if;
        else 
            input_buf_address1_local <= "XXXXXXXXXXXXX";
        end if; 
    ...
    pool1_out_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, pool1_out_full_n, ap_block_pp0_stage0_grp1)
    begin
    ...
    pool1_out_din <= max_val_4_reg_502;

    pool1_out_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001_grp1)
    begin
    ...
    select_ln155_1_fu_221_p3 <= 
        add_ln155_fu_183_p2 when (icmp_ln157_fu_189_p2(0) = '1') else 
        i_fu_70;
    select_ln155_fu_195_p3 <= 
        ap_const_lv4_0 when (icmp_ln157_fu_189_p2(0) = '1') else 
        j_fu_62;
    select_ln157_1_fu_319_p3 <= 
        ap_const_lv10_1 when (icmp_ln157_fu_189_p2(0) = '1') else 
        add_ln157_1_fu_313_p2;
    select_ln157_fu_249_p3 <= 
        add_ln157_fu_229_p2 when (and_ln155_fu_215_p2(0) = '1') else 
        select_ln155_fu_195_p3;
    tmp_1_fu_288_p6 <= ((((trunc_ln160_fu_265_p1 & empty_47_fu_257_p1) & ap_const_lv1_0) & empty_48_fu_261_p1) & ap_const_lv1_1);
    tmp_2_fu_347_p6 <= ((((trunc_ln160_reg_470 & empty_47_reg_458) & ap_const_lv1_1) & empty_48_reg_464) & ap_const_lv1_0);
    tmp_3_fu_363_p6 <= ((((trunc_ln160_reg_470 & empty_47_reg_458) & ap_const_lv1_1) & empty_48_reg_464) & ap_const_lv1_1);
    tmp_s_fu_269_p6 <= ((((trunc_ln160_fu_265_p1 & empty_47_fu_257_p1) & ap_const_lv1_0) & empty_48_fu_261_p1) & ap_const_lv1_0);
    ...
    zext_ln163_1_fu_358_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2_fu_347_p6),32));
    zext_ln163_2_fu_374_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_3_fu_363_p6),32));
    zext_ln163_fu_302_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_288_p6),32));
end behav;
