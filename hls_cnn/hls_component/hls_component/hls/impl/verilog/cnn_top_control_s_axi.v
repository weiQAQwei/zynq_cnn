...
#(parameter
    ...
    output wire [31:0]                   conv1_weights,
    output wire [31:0]                   conv1_bias,
    output wire [31:0]                   conv2_weights,
    output wire [31:0]                   conv2_bias,
    output wire [31:0]                   conv3_weights,
    output wire [31:0]                   conv3_bias,
...
localparam
    ...
    ADDR_CONV1_WEIGHTS_DATA_0 = 7'h20,
    ADDR_CONV1_WEIGHTS_CTRL   = 7'h24,
    ADDR_CONV1_BIAS_DATA_0    = 7'h28,
    ADDR_CONV1_BIAS_CTRL      = 7'h2c,
    ADDR_CONV2_WEIGHTS_DATA_0 = 7'h30,
    ADDR_CONV2_WEIGHTS_CTRL   = 7'h34,
    ADDR_CONV2_BIAS_DATA_0    = 7'h38,
    ADDR_CONV2_BIAS_CTRL      = 7'h3c,
    ADDR_CONV3_WEIGHTS_DATA_0 = 7'h40,
    ADDR_CONV3_WEIGHTS_CTRL   = 7'h44,
    ADDR_CONV3_BIAS_DATA_0    = 7'h48,
    ADDR_CONV3_BIAS_CTRL      = 7'h4c,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_conv1_weights = 'b0;
    reg  [31:0]                   int_conv1_bias = 'b0;
    reg  [31:0]                   int_conv2_weights = 'b0;
    reg  [31:0]                   int_conv2_bias = 'b0;
    reg  [31:0]                   int_conv3_weights = 'b0;
    reg  [31:0]                   int_conv3_bias = 'b0;
