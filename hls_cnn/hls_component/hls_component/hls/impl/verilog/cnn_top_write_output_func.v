...
module cnn_top_write_output_func (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [3:0] j_fu_60;
wire   [3:0] select_ln105_fu_219_p3;
reg   [9:0] indvar_flatten_fu_64;
wire   [9:0] select_ln105_3_fu_266_p3;
reg   [3:0] i_fu_68;
wire   [3:0] select_ln103_3_fu_191_p3;
reg   [11:0] indvar_flatten12_fu_72;
wire   [11:0] add_ln103_3_fu_130_p2;
...
wire   [3:0] add_ln103_fu_153_p2;
wire   [3:0] select_ln103_fu_165_p3;
wire   [0:0] and_ln103_fu_185_p2;
wire   [0:0] empty_fu_205_p2;
wire   [3:0] add_ln105_fu_199_p2;
wire   [5:0] oc_mid2_fu_211_p3;
wire   [4:0] trunc_ln108_6_fu_235_p1;
wire   [2:0] trunc_ln108_fu_227_p1;
wire   [2:0] trunc_ln108_5_fu_231_p1;
wire   [10:0] tmp_3_fu_239_p4;
wire   [9:0] add_ln105_3_fu_260_p2;
reg    ap_done_reg;
...
assign add_ln103_3_fu_130_p2 = (ap_sig_allocacmp_indvar_flatten12_load + 12'd1);

assign add_ln103_fu_153_p2 = (i_fu_68 + 4'd1);

assign add_ln105_3_fu_260_p2 = (indvar_flatten_fu_64 + 10'd1);

assign add_ln105_fu_199_p2 = (select_ln103_fu_165_p3 + 4'd1);
...
always @ (*) begin
    ap_block_state3_pp0_stage2_iter0 = (conv3_out_full_n == 1'b0);
end
...
assign conv3_out_din = output_buf_q0;

assign empty_fu_205_p2 = (icmp_ln105_fu_159_p2 | and_ln103_fu_185_p2);

assign icmp_ln103_fu_124_p2 = ((ap_sig_allocacmp_indvar_flatten12_load == 12'd2048) ? 1'b1 : 1'b0);

assign icmp_ln105_fu_159_p2 = ((indvar_flatten_fu_64 == 10'd256) ? 1'b1 : 1'b0);
...
assign select_ln103_3_fu_191_p3 = ((icmp_ln105_fu_159_p2[0:0] == 1'b1) ? add_ln103_fu_153_p2 : i_fu_68);

assign select_ln103_fu_165_p3 = ((icmp_ln105_fu_159_p2[0:0] == 1'b1) ? 4'd0 : j_fu_60);

assign select_ln105_3_fu_266_p3 = ((icmp_ln105_fu_159_p2[0:0] == 1'b1) ? 10'd1 : add_ln105_3_fu_260_p2);

assign select_ln105_fu_219_p3 = ((and_ln103_fu_185_p2[0:0] == 1'b1) ? add_ln105_fu_199_p2 : select_ln103_fu_165_p3);

assign tmp_3_fu_239_p4 = {{{trunc_ln108_6_fu_235_p1}, {trunc_ln108_fu_227_p1}}, {trunc_ln108_5_fu_231_p1}};

assign trunc_ln108_5_fu_231_p1 = select_ln105_fu_219_p3[2:0];

assign trunc_ln108_6_fu_235_p1 = oc_mid2_fu_211_p3[4:0];

assign trunc_ln108_fu_227_p1 = select_ln103_3_fu_191_p3[2:0];

assign xor_ln103_fu_173_p2 = (icmp_ln105_fu_159_p2 ^ 1'd1);

assign zext_ln108_fu_249_p1 = tmp_3_fu_239_p4;

endmodule //cnn_top_write_output_func
