...
module cnn_top_Block_entry_gmem1_wr_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg[15:0] m_axi_gmem1_0_WDATA;
reg[1:0] m_axi_gmem1_0_WSTRB;
...
reg   [31:0] output_r_read_reg_112;
reg    ap_block_state1;
reg   [31:0] gmem1_addr_reg_117;
wire    grp_write_output_top_fu_83_ap_start;
wire    grp_write_output_top_fu_83_ap_done;
wire    grp_write_output_top_fu_83_ap_idle;
wire    grp_write_output_top_fu_83_ap_ready;
wire    grp_write_output_top_fu_83_output_s_read;
wire    grp_write_output_top_fu_83_m_axi_gmem1_0_AWVALID;
wire   [31:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWADDR;
wire   [0:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWID;
wire   [31:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWLEN;
wire   [2:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWSIZE;
wire   [1:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWBURST;
wire   [1:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWLOCK;
wire   [3:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWCACHE;
wire   [2:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWPROT;
wire   [3:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWQOS;
wire   [3:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWREGION;
wire   [0:0] grp_write_output_top_fu_83_m_axi_gmem1_0_AWUSER;
wire    grp_write_output_top_fu_83_m_axi_gmem1_0_WVALID;
wire   [15:0] grp_write_output_top_fu_83_m_axi_gmem1_0_WDATA;
wire   [1:0] grp_write_output_top_fu_83_m_axi_gmem1_0_WSTRB;
wire    grp_write_output_top_fu_83_m_axi_gmem1_0_WLAST;
wire   [0:0] grp_write_output_top_fu_83_m_axi_gmem1_0_WID;
wire   [0:0] grp_write_output_top_fu_83_m_axi_gmem1_0_WUSER;
wire    grp_write_output_top_fu_83_m_axi_gmem1_0_ARVALID;
wire   [31:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARADDR;
wire   [0:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARID;
wire   [31:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARLEN;
wire   [2:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARSIZE;
wire   [1:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARBURST;
wire   [1:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARLOCK;
wire   [3:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARCACHE;
wire   [2:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARPROT;
wire   [3:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARQOS;
wire   [3:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARREGION;
wire   [0:0] grp_write_output_top_fu_83_m_axi_gmem1_0_ARUSER;
wire    grp_write_output_top_fu_83_m_axi_gmem1_0_RREADY;
wire    grp_write_output_top_fu_83_m_axi_gmem1_0_BREADY;
reg    grp_write_output_top_fu_83_ap_start_reg;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state10;
wire  signed [31:0] sext_ln250_fu_102_p1;
wire   [30:0] trunc_ln_fu_92_p4;
reg   [9:0] ap_NS_fsm;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 10'd1;
#0 grp_write_output_top_fu_83_ap_start_reg = 1'b0;
end

cnn_top_write_output_top grp_write_output_top_fu_83(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state10) & (grp_write_output_top_fu_83_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_write_output_top_fu_83_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state9)) begin
            grp_write_output_top_fu_83_ap_start_reg <= 1'b1;
        end else if ((grp_write_output_top_fu_83_ap_ready == 1'b1)) begin
            grp_write_output_top_fu_83_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_write_output_top_fu_83_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) & (grp_write_output_top_fu_83_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign grp_write_output_top_fu_83_ap_start = grp_write_output_top_fu_83_ap_start_reg;
...
assign output_s_read = grp_write_output_top_fu_83_output_s_read;

assign sext_ln250_fu_102_p1 = $signed(trunc_ln_fu_92_p4);

assign trunc_ln_fu_92_p4 = {{output_r_dout[31:1]}};

endmodule //cnn_top_Block_entry_gmem1_wr_proc
