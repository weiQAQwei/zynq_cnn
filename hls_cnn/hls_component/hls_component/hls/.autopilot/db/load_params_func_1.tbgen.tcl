set moduleName load_params_func_1
set isTopModule 0
...
set cdfgNum 42
set C_modelName {load_params_func.1}
...
set portList { 
	...
	{ local_weights_address0 sc_out sc_lv 14 signal 4 } 
	{ local_weights_ce0 sc_out sc_logic 1 signal 4 } 
	{ local_weights_we0 sc_out sc_logic 1 signal 4 } 
	{ local_weights_d0 sc_out sc_lv 16 signal 4 } 
	{ local_bias_address0 sc_out sc_lv 5 signal 5 } 
	{ local_bias_ce0 sc_out sc_logic 1 signal 5 } 
	{ local_bias_we0 sc_out sc_logic 1 signal 5 } 
	{ local_bias_d0 sc_out sc_lv 16 signal 5 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "27767", "Max" : "27767"}
	, {"Name" : "Interval", "Min" : "27767", "Max" : "27767"}
]}
