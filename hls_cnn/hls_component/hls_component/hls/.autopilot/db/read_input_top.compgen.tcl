...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_input_s \
    op interface \
    ports { input_s_din { O 16 vector } input_s_full_n { I 1 bit } input_s_write { O 1 bit } input_s_num_data_valid { I 9 vector } input_s_fifo_cap { I 9 vector } } \
} "
}
...
set InstName cnn_top_flow_control_loop_pipe_U
set CompName cnn_top_flow_control_loop_pipe
