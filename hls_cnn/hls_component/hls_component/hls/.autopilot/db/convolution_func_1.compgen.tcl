...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_top_mac_muladd_16s_16s_32ns_32_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_buf \
    op interface \
    ports { input_buf_address0 { O 14 vector } input_buf_ce0 { O 1 bit } input_buf_q0 { I 16 vector } } \
} "
} else {
