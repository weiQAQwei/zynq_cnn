set moduleName write_output_func
set isTopModule 0
...
set cdfgNum 42
set C_modelName {write_output_func}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict output_buf { MEM_WIDTH 15 MEM_SIZE 4096 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ output_buf int 15 regular {array 2048 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ conv3_out_din sc_out sc_lv 16 signal 1 } 
	{ conv3_out_full_n sc_in sc_logic 1 signal 1 } 
	{ conv3_out_write sc_out sc_logic 1 signal 1 } 
	{ conv3_out_num_data_valid sc_in sc_lv 12 signal 1 } 
	{ conv3_out_fifo_cap sc_in sc_lv 12 signal 1 } 
	{ output_buf_address0 sc_out sc_lv 11 signal 0 } 
...
set Spec2ImplPortList { 
	output_buf { ap_memory {  { output_buf_address0 mem_address 1 11 }  { output_buf_ce0 mem_ce 1 1 }  { output_buf_q0 mem_dout 0 15 } } }
