set moduleName write_output_top_Pipeline_VITIS_LOOP_192_1
set isTopModule 0
...
set cdfgNum 42
set C_modelName {write_output_top_Pipeline_VITIS_LOOP_192_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 1}  }
	{ sext_ln192 int 31 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln192", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln192 sc_in sc_lv 31 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln192", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "sext_ln192", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln192 { ap_none {  { sext_ln192 in_data 0 31 } } }
