...
set cdfgNum 42
set C_modelName {pooling_func}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict input_buf { MEM_WIDTH 16 MEM_SIZE 4096 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ input_buf int 16 regular {array 2048 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
...
set portList { 
	...
	{ input_buf_address0 sc_out sc_lv 11 signal 0 } 
	{ input_buf_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_buf_q0 sc_in sc_lv 16 signal 0 } 
	{ input_buf_address1 sc_out sc_lv 11 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_buf_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "input_buf", "role": "address0" }} , 
 	...
 	{ "name": "input_buf_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "input_buf", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	input_buf { ap_memory {  { input_buf_address0 mem_address 1 11 }  { input_buf_ce0 mem_ce 1 1 }  { input_buf_q0 mem_dout 0 16 }  { input_buf_address1 MemPortADDR2 1 11 }  { input_buf_ce1 MemPortCE2 1 1 }  { input_buf_q1 MemPortDOUT2 0 16 } } }
