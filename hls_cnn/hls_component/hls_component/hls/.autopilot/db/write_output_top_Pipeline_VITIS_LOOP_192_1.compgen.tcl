...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_s_dout { I 16 vector } output_s_empty_n { I 1 bit } output_s_read { O 1 bit } output_s_num_data_valid { I 10 vector } output_s_fifo_cap { I 10 vector } } \
} "
}
