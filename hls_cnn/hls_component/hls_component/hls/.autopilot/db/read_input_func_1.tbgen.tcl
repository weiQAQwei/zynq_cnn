set moduleName read_input_func_1
set isTopModule 0
...
set cdfgNum 42
set C_modelName {read_input_func.1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict input_buf { MEM_WIDTH 16 MEM_SIZE 16384 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ conv2_out int 16 regular {fifo 0 volatile }  }
	{ input_buf int 16 regular {array 8192 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ input_buf_address0 sc_out sc_lv 13 signal 1 } 
...
set Spec2ImplPortList { 
	...
	input_buf { ap_memory {  { input_buf_address0 mem_address 1 13 }  { input_buf_ce0 mem_ce 1 1 }  { input_buf_we0 mem_we 1 1 }  { input_buf_d0 mem_din 1 16 } } }
}
