set moduleName prepare_input_buf_func
set isTopModule 0
...
set cdfgNum 42
set C_modelName {prepare_input_buf_func}
...
set portList { 
	...
	{ pool1_out_dout sc_in sc_lv 16 signal 0 } 
	{ pool1_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ pool1_out_read sc_out sc_logic 1 signal 0 } 
	{ pool1_out_num_data_valid sc_in sc_lv 12 signal 0 } 
	{ pool1_out_fifo_cap sc_in sc_lv 12 signal 0 } 
	{ input_buf_address0 sc_out sc_lv 12 signal 1 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15751", "Max" : "15751"}
	, {"Name" : "Interval", "Min" : "15751", "Max" : "15751"}
]}
