...
architecture behave of cnn_top_control_s_axi is
    ...
    constant ADDR_CONV1_WEIGHTS_DATA_0 : INTEGER := 16#20#;
    constant ADDR_CONV1_WEIGHTS_CTRL   : INTEGER := 16#24#;
    constant ADDR_CONV1_BIAS_DATA_0    : INTEGER := 16#28#;
    constant ADDR_CONV1_BIAS_CTRL      : INTEGER := 16#2c#;
    constant ADDR_CONV2_WEIGHTS_DATA_0 : INTEGER := 16#30#;
    constant ADDR_CONV2_WEIGHTS_CTRL   : INTEGER := 16#34#;
    constant ADDR_CONV2_BIAS_DATA_0    : INTEGER := 16#38#;
    constant ADDR_CONV2_BIAS_CTRL      : INTEGER := 16#3c#;
    constant ADDR_CONV3_WEIGHTS_DATA_0 : INTEGER := 16#40#;
    constant ADDR_CONV3_WEIGHTS_CTRL   : INTEGER := 16#44#;
    constant ADDR_CONV3_BIAS_DATA_0    : INTEGER := 16#48#;
    constant ADDR_CONV3_BIAS_CTRL      : INTEGER := 16#4c#;
    ...
    signal int_conv1_weights   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_conv1_bias      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_conv2_weights   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_conv2_bias      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_conv3_weights   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_conv3_bias      : UNSIGNED(31 downto 0) := (others => '0');
