set moduleName write_output_func_2
set isTopModule 0
...
set cdfgNum 42
set C_modelName {write_output_func.2}
...
set portList { 
	...
	{ conv1_out_din sc_out sc_lv 16 signal 1 } 
	{ conv1_out_full_n sc_in sc_logic 1 signal 1 } 
	{ conv1_out_write sc_out sc_logic 1 signal 1 } 
	{ conv1_out_num_data_valid sc_in sc_lv 14 signal 1 } 
	{ conv1_out_fifo_cap sc_in sc_lv 14 signal 1 } 
