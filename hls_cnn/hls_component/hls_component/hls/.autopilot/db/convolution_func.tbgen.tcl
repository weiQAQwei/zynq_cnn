set moduleName convolution_func
set isTopModule 0
...
set cdfgNum 42
set C_modelName {convolution_func}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict input_buf { MEM_WIDTH 16 MEM_SIZE 6400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
dict set ap_memory_interface_dict output_buf { MEM_WIDTH 15 MEM_SIZE 4096 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ input_buf int 16 regular {array 3200 { 1 3 } 1 1 }  }
	{ local_weights int 16 regular {array 9216 { 1 3 } 1 1 }  }
	{ local_bias int 16 regular {array 32 { 1 3 } 1 1 }  }
	{ output_buf int 15 regular {array 2048 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ output_buf_address0 sc_out sc_lv 11 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_buf_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "output_buf", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "589832", "Max" : "589832"}
	, {"Name" : "Interval", "Min" : "589832", "Max" : "589832"}
]}
...
set Spec2ImplPortList { 
	input_buf { ap_memory {  { input_buf_address0 mem_address 1 12 }  { input_buf_ce0 mem_ce 1 1 }  { input_buf_q0 mem_dout 0 16 } } }
	...
	output_buf { ap_memory {  { output_buf_address0 mem_address 1 11 }  { output_buf_ce0 mem_ce 1 1 }  { output_buf_we0 mem_we 1 1 }  { output_buf_d0 mem_din 1 15 } } }
}
